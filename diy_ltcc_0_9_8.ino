...
uint8_t timer2OFCompare = 8;            // scale this multiplier with rpm to reduce uart induced lag
...
void setup() {
  ...
  //TCCR2B |= (1<<CS12)|(1<<CS10); // 1024 prescaler   < duh, these are prescaler constants for timer1
  TCCR2B |= (1<<CS20)|(1<<CS21)|(1<<CS22); // 1024 prescaler - (192 * 1024 * (timer2OFCompare + 1)) / 16mhz = timer interval
  TIMSK2 |= (1 << OCIE2A);
